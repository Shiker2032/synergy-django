# Generated by Django 5.0.3 on 2024-03-14 16:34
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='news',
            name='photo',
            field=models.ImageField(upload_to='media/%Y/%m/%d', verbose_name='Картинка'),
        ),
        migrations.AlterField(
            model_name='news',
            name='title',
        ...
        migrations.AddField(
            model_name='news',
            name='category',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='newsApp.category'),
        ),
    ]
